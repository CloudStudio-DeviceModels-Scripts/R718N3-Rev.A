...
function getEndpoints(deviceAddress, endpoints)
{
    ...
    endpoints.addEndpoint("1", "Current (A) Red Sensor", endpointType.currentSensor);

    endpoints.addEndpoint("2", "Current (B) Silver Sensor", endpointType.currentSensor);

    endpoints.addEndpoint("3", "Current (C) Black Sensor", endpointType.currentSensor);
}
